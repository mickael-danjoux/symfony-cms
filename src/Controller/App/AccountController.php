<?php
	...
	class AccountController extends AbstractController
	{
		...
		public function forgotPassword(Request $request, UserRepository $repo, MailerInterface $mailer)
		{
			...
			return $this->render('app/account/ask_reset_password.html.twig', [
			]);
		...
		public function newPassword(?User $user, Request $request)
		{
			...
			return $this->render('app/account/form_reset_password.html.twig', [
